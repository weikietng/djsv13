...
exports.default = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var target, embed, embed;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        target = interaction.options.getMember('user');
                        if (!target.roles.cache.has("861690102966648842")) return [3 /*break*/, 2];
                        return [4 /*yield*/, target.roles.remove("861690102966648842")];
                    case 1:
                        _b.sent();
                        embed = new discord_js_1.MessageEmbed()
                            ...
                            .setColor("DARK_GREEN");
                        return [2 /*return*/, interaction.reply({ embeds: [embed] })];
                    case 2:
                        embed = new discord_js_1.MessageEmbed()
                            .setTitle("Not Muted")
